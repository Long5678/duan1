...
-- Thời gian đã tạo: Th10 26, 2023 lúc 02:27 PM
...
INSERT INTO `order` (`id`, `customer_id`, `order_dates`, `status`, `user`, `email`, `address`, `phone`, `total`) VALUES
(1, 0, '0000-00-00 00:00:00', '', '', '', '', '', 0),
(2, 0, '0000-00-00 00:00:00', '', 'vanvien', 'vientvpd08408@fpt.edu.vn', '', '', 699695),
(3, 0, '0000-00-00 00:00:00', 'pedding', 'vanvien', 'vientvpd08408@fpt.edu.vn', '08 hồ quý ly', '0961770863', 180000),
(4, 0, '0000-00-00 00:00:00', 'pedding', 'vanvien', 'vientvpd08408@fpt.edu.vn', '99huynhtanphat', '0123456789', 25000);
...
INSERT INTO `order_details` (`id`, `product_id`, `order_id`, `quantity`, `product_name`, `price`) VALUES
(1, 21, 2, '1', 'Cà Phê Cherry', '55000'),
(2, 20, 2, '1', 'Cà phê Premium Blend ', '180000'),
(3, 18, 2, '1', 'Cà phê bột mixphin', '150000'),
(4, 16, 2, '3', 'Cà phê hòa tan G7', '25000'),
(5, 13, 2, '1', 'Cà phê sáng tạo 8', '239695'),
(6, 20, 3, '1', 'Cà phê Premium Blend ', '180000'),
(7, 16, 4, '1', 'Cà phê hòa tan G7', '25000');
...
(15, 5, 'Nescafe 3 in 1', 'Cà phê rang xay hòa tan NESCAFÉ 3in1 Đậm Vị Cà Phê được sản xuất từ những hạt cà phê nguyên chất được tuyển chọn kỹ càng, mang đến tách cà phê chuẩn gu đặc trưng với hương vị mạnh mẽ hòa quyện cùng sữa béo thơm ngon đến giọt cuối cùng.', 56000, 'sp chinh.jpg', 'Nestle', 'Robusta đậm đà đặc trưng cùng hương nồng nàn từ hạt Arabica! ', '1 năm', '340g', 0, 30),
...
(17, 5, 'Cà phê Gu mạnh 3 in 1', 'Cà phê G7 Gu Mạnh X2 hội tụ đủ những yếu tố đặc biệt như nguyên liệu tốt nhất, sản xuất trên công nghệ hàng đầu, bí quyết không thể sao chép, đã làm nên một loại cà phê thượng hạng và là niềm tự hào của Trung Nguyên bởi có chất lượng tuyệt hảo, đáp ứng được sở thích uống cà phê mạnh như cà phê rang xay, pha phin của người Việt và tiết kiệm thời gian trong cuộc sống hiện đại.', 55000, '5000069_3.jpg', 'Trung Nguyên', 'Cà phê hòa tan có hương vị mạnh gấp đôi các loại cà phê hòa tan thông thường.', '2 năm.', 'Hộp 12 gói x 25gr', 30, 0),
...
(20, 2, 'Cà phê Premium Blend ', 'Cà phê rang xay Premium Blend là một sản phẩm cà phê đặc biệt được chắt lọc từ những vùng nguyên liệu ngon nhất thế giới kết hợp công nghệ sản xuất hàng đầu và phương thức rang xay độc đáo không thể sao chép của Trung Nguyên, mang đến hương vị quyến rũ, đậm đà.', 180000, '1-3-600x600.jpg', 'Trung Nguyên', 'Nước pha màu nâu đậm, mùi thơm đặc trưng, bền, đầm, vị đậm đà, hàm lượng Caffeine: ≥ 1 %.', '2 năm', 'Lon 425gr.', 0, 15),
(21, 1, 'Cà Phê Cherry', 'Cà phê Cherry còn được gọi là cà phê Mít. Hạt cà phê Cherry có màu vàng, sáng bóng rất đẹp. Hương vị tuy không đậm đà như Robusta, cũng không nồng nàn như Arabica, nhưng cà phê Cherry mang đặc trưng riêng: chua nhẹ, hơi chát, hàm lượng caffein thấp, cùng hương thơm thoang thoảng.', 55000, 'cà phê cherry.jpg', ' Phúc Long Heritage', 'Hạt cà phê vàng, sáng bóng rất đẹp. Khi pha tạo ra mùi thơm thoang thoảng, đặc biệt là vị chua của cherry tạo ra một cảm giác thật sảng khoái.', '2 năm', '200g', 10, 0),
(22, 1, 'Legend Success 1', 'Việc chọn lựa nguyên liệu là 01 bí quyết, cùng với nghệ thuật rang tạo nên sản phẩm cà phê Năng Lượng đượm hương thơm, thoáng mùi khói nhẹ, đậm vị cà phê nguyên bản, hậu vị đậm.', 150000, '2-2.jpg', 'Trung Nguyên', 'Thể chất đậm, mạnh, gu truyền thống', '2 năm', '1kg/bịch', 0, 0);
